...
/**
 * check_if_match - function that checks if a character matches any in a string
 * @c: is the character to check
 * @str: is the string to check
 *
 * Return: 1 if match, otherwise 0 if no match
 */
 ...
 *
 * Return: pointer to the next token otherwise, NULL
 */
...
/**
 * build_path - function that combines two strings one representing the
 * path directory and another representing the command file
