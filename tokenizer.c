...
/**
 * tokenizer - function that tokenizes a buffer with a delimiter
...
/**
 * tokenize - funtion that tokenizes a buffer with a delimiter
 * just use for for_child
 * @line: is the buffer to tokenize
 * @delimiter: is the delimiter to tokenize along
 * @token_count: is the token count, size
 * Return: pointer to an array of pointers to the tokens
 */
...
/**
 * token_interface - the token interface
