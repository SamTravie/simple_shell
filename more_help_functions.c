...
/**
 * new_help_history - function that help builtin command history
...
/**
 * new_help_unalias - function that help builtin command unalias
 * @vars: if command matches a builtin name, text file is sent to stdout
 * Return: 0 on success
 */
...
/**
 * new_help_unset - function that help builtin command unset
 * @vars: if command matches a builtin name, text file is sent to stdout
 * Return: 0 on success
 */
...
/**
 * new_help_unsetenv - fucntion that help builtin command unsetenv
 * @vars: if command matches a builtin name, text file is sent to stdout
 * Return: 0 on success
 */
...
/**
 * new_help_setenv - function that help builtin command setenv
 * @vars: if command matches a builtin name, text file is sent to stdout
 * Return: 0 on success
 */
